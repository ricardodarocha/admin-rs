...
(
	...
	:razao_social,
	:nome,
	(select id from tipo_pessoa where simbolo = 'PJ'),
	(select id from identificacao where descricao = :documento_identificacao),
	(select id from status_pessoa where descricao = :status),
